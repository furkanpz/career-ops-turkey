...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported through the maintainer channels on [GitHub](https://github.com/furkanpz/career-ops-turkey). If the report is sensitive, use GitHub private vulnerability reporting so the details are not disclosed publicly. All complaints will be reviewed and investigated.
