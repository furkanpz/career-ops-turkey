...
Turkey metadata keys also stay English and parser-safe:
...
`data/tr-listings.jsonl` is an additive user-layer sidecar generated by scanner/report flows. Read it for Turkey dashboard or pipeline context, but do not overwrite it manually unless the user explicitly asks for data repair.
