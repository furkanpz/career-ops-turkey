...
<p align="center">
  <img src="docs/hero-banner.jpg" alt="Career-Ops -- 멀티 에이전트 취업 시스템" width="800">
</p>

<p align="center">
  <em>Career-Ops Turkey는 튀르키예 및 EMEA 구직 워크플로를 위해 유지관리됩니다.</em><br>
  <strong>터키 locale 지원을 포함한 MIT 라이선스 Career-Ops 공개 포크입니다.</strong><br>
  <em>Furkan Uyar가 유지관리합니다.</em>
</p>
...
이 포크는 [Furkan Uyar](https://github.com/furkanpz)가 유지관리하며 Santiago Fernández de Valderrama의 MIT 라이선스 [Career-Ops](https://github.com/santifer/career-ops) 프로젝트를 기반으로 합니다.
...
Career-Ops Turkey는 [Furkan Uyar](https://github.com/furkanpz)가 유지관리하며 Santiago Fernández de Valderrama의 MIT 라이선스 [Career-Ops](https://github.com/santifer/career-ops)를 기반으로 합니다. 원본 copyright 고지는 [LICENSE](LICENSE)에 보존되어 있습니다.
...
<a href="https://www.star-history.com/?repos=furkanpz%2Fcareer-ops-turkey&type=timeline&legend=top-left">
 <picture>
   ...
   <img alt="Star History 차트" src="https://api.star-history.com/chart?repos=furkanpz/career-ops-turkey&type=timeline&legend=top-left" />
 </picture>
</a>
...
- 버그 및 기능 요청: [GitHub Issues](https://github.com/furkanpz/career-ops-turkey/issues)
- 사용 질문: [GitHub Discussions](https://github.com/furkanpz/career-ops-turkey/discussions)
- 보안 제보: [GitHub Security Advisories](https://github.com/furkanpz/career-ops-turkey/security/advisories/new)
