...
<p align="center">
  <em>Career-Ops Turkey はトルコおよび EMEA 向けの求職ワークフローとして保守されています。</em><br>
  <strong>トルコ locale 対応を含む、MIT ライセンスの Career-Ops 公開フォークです。</strong><br>
  <em>Furkan Uyar が保守しています。</em>
</p>
...
このフォークは [Furkan Uyar](https://github.com/furkanpz) が保守しており、Santiago Fernández de Valderrama による MIT ライセンスの [Career-Ops](https://github.com/santifer/career-ops) をベースにしています。
...
Career-Ops Turkey は [Furkan Uyar](https://github.com/furkanpz) が保守しており、Santiago Fernández de Valderrama による MIT ライセンスの [Career-Ops](https://github.com/santifer/career-ops) をベースにしています。元の copyright 表記は [LICENSE](LICENSE) に保持されています。
...
- バグと機能要望: [GitHub Issues](https://github.com/furkanpz/career-ops-turkey/issues)
- 使い方の質問: [GitHub Discussions](https://github.com/furkanpz/career-ops-turkey/discussions)
- セキュリティ報告: [GitHub Security Advisories](https://github.com/furkanpz/career-ops-turkey/security/advisories/new)
